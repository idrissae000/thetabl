...
const base =
  'inline-block font-sans text-xs font-semibold tracking-ultra uppercase px-8 py-3 transition-all duration-400 ease-out cursor-pointer hover:-translate-y-px'
